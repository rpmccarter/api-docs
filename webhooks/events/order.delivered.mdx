---
title: "Event: order.delivered"
sidebarTitle: "order.delivered"
description: "Emitted when an order has been delivered. If the order has multiple shipments, this is emitted when all shipments have been delivered."
---
