---
title: "Event: order.gift_opened"
sidebarTitle: "order.gift_opened"
description: "Emitted when a gift is first opened. Note that if you open the gift link yourself, you might trigger this event."
---
