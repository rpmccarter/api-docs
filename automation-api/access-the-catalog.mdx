---
title: "Automation API: Access the product catalog"
sidebarTitle: "Access the catalog"
---

To access the product catalog, make a request (using your API key) to:
...
For more information, including the schema of the Product object, check out the [API reference for the products endpoint](/api/products/list-all-active-products).
